...
export const MULTI_YEAR_FESTIVALS: MultiYearFestivalDefinition[] = [
  // 🎆 1. New Year (1 January)
  {
    ...
    theme: {
      ...
      heroSubheadline: 'Ring in the New Year with Harino’s handcrafted hot gourmet pizzas and artisan garlic bread. Flat 20% OFF on Pizzas & 10% OFF on Others on New Year’s Day!',
    ...
    offer: {
      ...
      terms: '20% OFF on Pizzas + 10% OFF on other items. Automatically applied on food subtotal in cart.',
    },
  },
  ...
  // 🪁 3. Makar Sankranti / Pongal (14 January)
  {
    ...
    dateSource: 'solar',
    datesByYear: {
      2026: { festivalDay: '2026-01-14', festivalDayEnd: '2026-01-15', campaignStartDays: 5, offerDurationDays: 2, themeDurationDays: 6 },
      2027: { festivalDay: '2027-01-14', festivalDayEnd: '2027-01-15', campaignStartDays: 5, offerDurationDays: 2, themeDurationDays: 6 },
      2028: { festivalDay: '2028-01-14', festivalDayEnd: '2028-01-15', campaignStartDays: 5, offerDurationDays: 2, themeDurationDays: 6 },
      2029: { festivalDay: '2029-01-14', festivalDayEnd: '2029-01-15', campaignStartDays: 5, offerDurationDays: 2, themeDurationDays: 6 },
      2030: { festivalDay: '2030-01-14', festivalDayEnd: '2030-01-15', campaignStartDays: 5, offerDurationDays: 2, themeDurationDays: 6 },
    },
    theme: {
  ...
  // 🎨 7. Holi & Holika Dahan (3-4 March 2026)
  {
    ...
    dateSource: 'lunar',
    datesByYear: {
      2026: { festivalDay: '2026-03-03', festivalDayEnd: '2026-03-04', campaignStartDays: 6, offerDurationDays: 2, themeDurationDays: 7 },
      2027: { festivalDay: '2027-03-22', festivalDayEnd: '2027-03-23', campaignStartDays: 6, offerDurationDays: 2, themeDurationDays: 7 },
      2028: { festivalDay: '2028-03-11', festivalDayEnd: '2028-03-12', campaignStartDays: 6, offerDurationDays: 2, themeDurationDays: 7 },
      2029: { festivalDay: '2029-02-28', festivalDayEnd: '2029-03-01', campaignStartDays: 6, offerDurationDays: 2, themeDurationDays: 7 },
      2030: { festivalDay: '2030-03-19', festivalDayEnd: '2030-03-20', campaignStartDays: 6, offerDurationDays: 2, themeDurationDays: 7 },
    },
    theme: {
  ...
  // 🪔 17. Diwali / Deepavali (SUNDAY, 8 NOVEMBER 2026) — MAJOR THEME
  {
    ...
    dateSource: 'lunar',
    datesByYear: {
      2026: { festivalDay: '2026-11-06', festivalDayEnd: '2026-11-08', campaignStartDays: 7, offerDurationDays: 3, themeDurationDays: 10 },
      2027: { festivalDay: '2027-10-28', festivalDayEnd: '2027-10-29', campaignStartDays: 7, offerDurationDays: 2, themeDurationDays: 10 },
      2028: { festivalDay: '2028-11-15', festivalDayEnd: '2028-11-17', campaignStartDays: 7, offerDurationDays: 3, themeDurationDays: 10 },
      2029: { festivalDay: '2029-11-04', festivalDayEnd: '2029-11-06', campaignStartDays: 7, offerDurationDays: 3, themeDurationDays: 10 },
      2030: { festivalDay: '2030-10-25', festivalDayEnd: '2030-10-27', campaignStartDays: 7, offerDurationDays: 3, themeDurationDays: 10 },
    },
    theme: {
      primaryAccent: '#f59e0b',
  ...
  // ☀️ 19. Chhath Puja (15 November 2026)
  {
    ...
    dateSource: 'lunar',
    datesByYear: {
      2026: { festivalDay: '2026-11-14', festivalDayEnd: '2026-11-15', campaignStartDays: 4, offerDurationDays: 2, themeDurationDays: 6 },
      2027: { festivalDay: '2027-11-03', festivalDayEnd: '2027-11-04', campaignStartDays: 4, offerDurationDays: 2, themeDurationDays: 6 },
      2028: { festivalDay: '2028-11-21', festivalDayEnd: '2028-11-22', campaignStartDays: 4, offerDurationDays: 2, themeDurationDays: 6 },
      2029: { festivalDay: '2029-11-10', festivalDayEnd: '2029-11-11', campaignStartDays: 4, offerDurationDays: 2, themeDurationDays: 6 },
      2030: { festivalDay: '2030-10-31', festivalDayEnd: '2030-11-01', campaignStartDays: 4, offerDurationDays: 2, themeDurationDays: 6 },
    },
    theme: {
      primaryAccent: '#ea580c',
      secondaryAccent: '#f59e0b',
